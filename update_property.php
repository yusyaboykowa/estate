...
if(isset($_POST['update']))
{
    ...
    $update_listing = $conn->prepare("UPDATE `property` SET property_name = ?, address = ?, price = ?, type = ?, offer = ?, status = ?, furnished = ?, rooms = ?, deposite = ?, bedroom = ?, bathroom = ?, carpet = ?, age = ?, total_floors = ?, room_floor = ?, loan = ?, lift = ?, security_guard = ?, play_ground = ?, garden = ?, water_supply = ?, power_backup = ?, parking_area = ?, gym = ?, shopping_mall = ?, hospital = ?, school = ?, market_area = ?, description = ? WHERE id = ?");   
    $update_listing->execute([$property_name, $address, $price, $type, $offer, $status, $furnished, $rooms, $deposite, $bedroom, $bathroom, $carpet, $age, $total_floors, $room_floor, $loan, $lift, $security_guard, $play_ground, $garden, $water_supply, $power_backup, $parking_area, $gym, $shopping_mall, $hospital, $school, $market_area, $description, $update_id]);
...
<html lang="en">
    ...
    <body>
        ...
        <section class="property-form">
            <?php
            $select_property = $conn->prepare("SELECT * FROM `property` WHERE id = ? ORDER BY date DESC LIMIT 1");
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="flex">
                    ...
                    <div class="box">
                        <p>deposite<span>*</span></p>
                        <input type="number" name="deposite" maxlength="10" min="0" max="9999999999" required placeholder="enter deposite amount" class="input" value="<?= $fetch_property['deposite'];?>">
                    </div>
                    <div class="box">
                    ...
                    <div class="box">
                        ...
                        <select name="rooms" class="input" required>
                            <option value="<?= $fetch_property['rooms'];?>" selected><?= $fetch_property['rooms'];?></option>
                    ...
                    <div class="box">
                        <p>quantity of bedrooms<span>*</span></p>
                        <select name="bedroom" class="input" required>
                            <option value="<?= $fetch_property['bedroom'];?>" selected><?= $fetch_property['bedroom'];?></option>
                    ...
                    <div class="box">
                        <p>quantity of bathrooms<span>*</span></p>
                        <select name="bathroom" class="input" required>
                            <option value="<?= $fetch_property['bathroom'];?>" selected><?= $fetch_property['bathroom'];?></option>
                            <option value="1">1 bathroom</option>
                            <option value="2">2 bathrooms</option>
                            <option value="3">3 bathdrooms</option>
                            <option value="4">4 bathrooms</option>
                            <option value="5">5 bathrooms</option>  
                        </select>   
                    </div>
                    <div class="box">
                        <p>quantity of banconys <span>*</span></p>
                        <select name="balcony" class="input" required>
                            <option value="<?= $fetch_property['balcony'];?>" selected><?= $fetch_property['balcony'];?></option>
                    ...
                    <div class="box">
                        ...
                        <input type="number" name="age" maxlength="2" min="0" max="99" required placeholder="how old is the property" class="input" value="<?= $fetch_property['age'];?>">
                    </div>
                    <div class="box">
                        <p>total floors<span>*</span></p>
                        <input type="number" name="total_floors" maxlength="2" min="0" max="99" required placeholder="how many floors available?" class="input" value="<?= $fetch_property['total_floors'];?>">
                    </div>
                    <div class="box">
                    ...
                    <div class="box">
                        <p><span>*</span></p>
                        <textarea name="description" cols="30" rows="10" maxlength="1000" required placeholder="enter property description" class="input"><?= $fetch_property['description']; ?></textarea>
                    </div>
                    <div class="checkbox">
                        <div class="box">
                    ...
                    <div class="box">
                        <img src="uploaded_files/<?= $fetch_property['image_01'];?>">
